...
async def gbanuser(client, message: Message, _):
    ...
    await message.reply_sticker("CAACAgUAAxkBAAEBoJdjyUNWO8Ag69yP6ATMzNhVcJMLtgAC8wkAAkPUEVUqu39UYMelLC0E")
...
async def gungabn(client, message: Message, _):
    ...
    await message.reply_sticker("CAACAgUAAxkBAAEBoJxjyUOemxhMZYVrsKzabqI-2oNhnQACgwUAAqPJSVbA0oAJLQc_7S0E")
    await message.reply_text(
